...
// import { generateSessionDates, getSessionTimes } from "@/utils/date";
// const ScheduleTable = () => {
...
//   const sessionDates = generateSessionDates(days, scheduleData.length);
//   const sessionTimes = getSessionTimes(times, scheduleData);
...
//                       <span className={styles.dateText}>
//                         {sessionDates[index] || "تاريخ غير متاح"}
//                       </span>
//                     </span>
//                     <span className={styles.timeText}>
//                       {sessionTimes[index] || "الوقت غير متاح"}
//                     </span>
//                   </div>
//                 </td>
...
//               <FaCalendarAlt />{" "}
//               <span>{sessionDates[index] || "تاريخ غير متاح"}</span>
//             </div>
//             <div className={styles.cardDate}>
//               <FaClock /> {sessionTimes[index] || "الوقت غير متاح"}
//             </div>
...
//               </div>
//             </div>
//             <div className={styles.statusItem}></div>
